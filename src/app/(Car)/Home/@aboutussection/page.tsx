...
const AboutUSsections = () => {
  ...
  return (
    <>
      <section
        id="aboutus-section"
        className="relative h-120 border md:ml-20 md:mr-20 lg:ml-40 lg:mr-40 rounded-2xl overflow-hidden mt-3 flex justify-center  bg-black/10 "
      >
        <Image
        ...
        />
        <div
          className={`relative top-10 md:top-40  ${poppins.variable} font-sans`}
        >
